...
const FLASH_QUESTIONS = [
  {
    id: "q1",
    text: "¿Habrá algún jugador que se lesione y quede fuera de temporada?",
    blockable: false,
    type: "select",
    options: [
      { id: "Sí", label: "Sí", kickoff: "2025-11-27T17:30:00" },
      { id: "No", label: "No", kickoff: "2025-11-27T17:30:00" }
    ]
  },
  {
    id: "q2",
    text: "¿Habrá algún gol de campo de +50 yardas?",
    blockable: false,
    type: "select",
    options: [
      { id: "Sí", label: "Sí", kickoff: "2025-11-27T17:30:00" },
  ...
  {
    id: "q3",
    text: "¿Qué quarterback (QB) lanzara más touchdowns?",
    blockable: true,
    type: "select",
    options: [
      ...
      { id: "B. Nix",     label: "Bo Nix (Broncos)", kickoff: null },
      ...
      { id: "J. Herbert",     label: "Justin Herbert (Chargers)", kickoff: null },
      { id: "P. Mahomes",     label: "Patrick Mahomes (Chiefs)", kickoff: null },
      { id: "D. Jones",       label: "Daniel Jones (Colts)", kickoff: null },
      { id: "M. Mariota",     label: "Marcus Mariota (Commanders)", kickoff: null },
      { id: "D. Prescott",    label: "Dak Prescott (Cowboys)", kickoff: null },
      { id: "T. Tagovailoa",     label: "Tua Tagovailoa (Dolphins)", kickoff: null },
  ...
  {
    id: "q4",
    text: "¿Cual quarterback (QB) tendra mas % de pases completos?",
    blockable: true,
    type: "select",
    options: [
      { id: "B. Purdy",       label: "Brock Purdy (49ers)", kickoff: null },
