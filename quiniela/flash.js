...
const FLASH_QUESTIONS = [
  ...
  {
    id: "q3-team-most-points",
    text: "¿Qué equipo anotará más puntos en la jornada?",
    blockable: true,
    type: "select",
    options: [
      { id: "49ers", label: "49ers", kickoff: null },
      { id: "eagles", label: "Eagles", kickoff: null },
      { id: "bills", label: "Bills", kickoff: null },
      { id: "dolphins", label: "Dolphins", kickoff: null }
    ]
  }
];
